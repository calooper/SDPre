...
public class TriangleIdent {
  public static void  main (String [] args) {
    ...
    //input
    System.out.println( "Please type in side lengths of a triangle started with side A: ");
...
if (angA + angB + angC > 179.9 && angA + angB + angC < 180.1) { //rounding issues with Math.acos
